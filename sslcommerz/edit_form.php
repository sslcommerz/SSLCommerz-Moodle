...
/**
 * Adds new instance of enrol_sslcommerz to specified course or edits current instance.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_sslcommerz_edit_form extends moodleform
{
    /**
     * Sets up moodle form.
     * @return void
    ...
    public function definition()
    {
        ...
        $mform->addElement('header', 'header', get_string('pluginname', 'enrol_sslcommerz'));
        ...
        $mform->addElement('text', 'cost', get_string('cost', 'enrol_sslcommerz') , array(
            'size' => 4
        ));
        ...
        $mform->addElement('select', 'currency', get_string('currency', 'enrol_sslcommerz') , $currencies);
        ...
        $mform->addElement('duration', 'enrolperiod', get_string('enrolperiod', 'enrol_sslcommerz') , array(
            'optional' => true,
            'defaultunit' => 86400
        ));
        ...
        $mform->addElement('date_time_selector', 'enrolstartdate', get_string('enrolstartdate', 'enrol_sslcommerz') , array(
            'optional' => true
        ));
        $mform->setDefault('enrolstartdate', 0);
        $mform->addHelpButton('enrolstartdate', 'enrolstartdate', 'enrol_sslcommerz');

        $mform->addElement('date_time_selector', 'enrolenddate', get_string('enrolenddate', 'enrol_sslcommerz') , array(
            'optional' => true
        ));

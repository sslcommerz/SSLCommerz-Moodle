...
class enrol_sslcommerz_plugin extends enrol_plugin {
    ...
    public function add_course_navigation($instancesnode, stdClass $instance) {
        if ($instance->enrol !== 'sslcommerz') {
             throw new coding_exception('Invalid enrol instance type!');
        }

        $context = context_course::instance($instance->courseid);
        if (has_capability('enrol/sslcommerz:config', $context)) {
            $managelink = new moodle_url('/enrol/sslcommerz/edit.php',
    ...
    public function get_action_icons(stdClass $instance) {
        ...
        if (has_capability('enrol/sslcommerz:config', $context)) {
            $editlink = new moodle_url("/enrol/sslcommerz/edit.php",
                                       array('courseid' => $instance->courseid, 'id' => $instance->id));
    ...
    public function get_newinstance_link($courseid) {
        ...
        if (!has_capability('moodle/course:enrolconfig', $context) or !has_capability('enrol/sslcommerz:config', $context)) {
            return null;
        }

        // Multiple instances supported - different cost for different roles.
        return new moodle_url('/enrol/sslcommerz/edit.php', array('courseid' => $courseid));
    }
    /**
    ...
    public function enrol_page_hook(stdClass $instance) {
        ...
        if (abs($cost) < 0.01) {
            ...
            if (isguestuser()) {
                ...
                include($CFG->dirroot.'/enrol/sslcommerz/enrolment_form.php');
            }
    ...
    public function get_user_enrolment_actions(course_enrolment_manager $manager, $ue) {
        ...
        $params['ue'] = $ue->id;
        if ($this->allow_unenrol($instance) && has_capability("enrol/sslcommerz:unenrol", $context)) {
        ...
        if ($this->allow_manage($instance) && has_capability("enrol/sslcommerz:manage", $context)) {
    ...
    public function can_delete_instance($instance) {
        $context = context_course::instance($instance->courseid);
        return has_capability('enrol/sslcommerz:config', $context);
    }
    /**
